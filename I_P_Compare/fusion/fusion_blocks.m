...
imported_color = load('steg/prediction/I_svm_prediction.mat');
svm_predictions = imported_color.label_color;

imported_deep = load('deep/predictions/I_deep_predictions.mat');
deep_predictions = imported_deep.classification_labels_frame;
...
import_expected_labels = load('labels/test_labels_frame');
