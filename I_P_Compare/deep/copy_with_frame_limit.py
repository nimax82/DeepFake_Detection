...
nb_frame = 20
input_folder_path = '/Volumes/VERBATIM_HD/Stage_Maxime/Celeb-DF-v2/deep/limited_train_val'
output_folder_path = '/Volumes/VERBATIM_HD/Stage_Maxime/Celeb-DF-v2/I_P_Compare/all/train_val'
