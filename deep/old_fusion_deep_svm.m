svm_prediction = load('sstn/prediction/svm_predictions').label_color;
deep_prediction = load('sstn/prediction/deep_predictions').deep_predictions;
...
expected_labels_video = load('sstn/steg/features/test/test_labels_video').expected_labels_video;
result_labels_fusion = NaN(numel(svm_prediction) / nb_frame, 1);
sum_fusion = 0;
j = 0;
