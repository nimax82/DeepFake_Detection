...
def face_extraction(video_src):
    ...
    cascade_fn = "pre-processing/data/haarcascades/haarcascade_frontalface_alt.xml"
    nested_fn  = "pre-processing/data/haarcascades/haarcascade_eye.xml"
